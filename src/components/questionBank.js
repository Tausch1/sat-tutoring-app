    ...
    'Square and Cubic Units': [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            question: "Convert 5 meters per second² to kilometers per hour². (1 km = 1000 m)",
            choices: ["46.656 km/h²", "64.8 km/h²", "72 km/h²", "86.4 km/h²", "108 km/h²"],
            correctAnswer: 1
          },
          {
            question: "A car accelerates at 2.5 meters per second². What is this acceleration in miles per minute²? (1 mile ≈ 1609.34 meters)",
            choices: ["0.0342 mi/min²", "0.0558 mi/min²", "0.0684 mi/min²", "0.0821 mi/min²", "0.0957 mi/min²"],
            correctAnswer: 1
          },
          {
            question: "Convert 15 feet per second² to yards per minute². (1 yard = 3 feet)",
            choices: ["150 yd/min²", "300 yd/min²", "450 yd/min²", "600 yd/min²", "750 yd/min²"],
            correctAnswer: 2
          },
          {
      ...
      },
      {
        ...
        questions: [
          ...
          {
            question: "A rocket accelerates at 49 meters per second². What is this acceleration in kilometers per hour per minute? (1 km = 1000 m)",
            choices: ["1.764 km/h/min", "2.94 km/h/min", "3.528 km/h/min", "4.116 km/h/min", "5.88 km/h/min"],
            correctAnswer: 1
          },
          {
            question: "Convert 0.75 miles per minute² to meters per second². (1 mile ≈ 1609.34 meters)",
            choices: ["8.05 m/s²", "12.07 m/s²", "16.09 m/s²", "20.12 m/s²", "24.14 m/s²"],
            correctAnswer: 3
          },
          {
            question: "An object's acceleration is measured as 3.6 kilometers per hour per second. What is this acceleration in feet per minute²? (1 km ≈ 3280.84 feet)",
            choices: ["3,280.84 ft/min²", "4,374.45 ft/min²", "5,468.07 ft/min²", "6,561.68 ft/min²", "7,655.29 ft/min²"],
            correctAnswer: 2
          },
          {
            question: "A particle accelerates at 2.5 centimeters per second². What is this acceleration in kilometers per day²?",
            choices: ["14.4 km/day²", "18.6 km/day²", "22.8 km/day²", "27.0 km/day²", "31.2 km/day²"],
            correctAnswer: 1
          },
          {
